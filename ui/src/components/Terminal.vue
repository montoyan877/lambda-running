<template>
  <div class="terminal-container w-full h-full overflow-y-auto bg-dark-800 text-gray-200 font-mono text-sm">
    <div v-if="logs.length === 0" class="p-4 text-center text-gray-400 flex items-center justify-center h-full">
    ...
    <div v-else>
      <div 
        ...
        :key="index" 
        class="py-1 px-3 border-b border-dark-700 whitespace-pre-wrap"
        :class="{
